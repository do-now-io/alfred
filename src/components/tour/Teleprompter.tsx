import { MdMic, MdStop, MdFiberManualRecord } from "react-icons/md";
...
export default function Teleprompter({
  recording, elapsed, onStart, onStop,
}: {
  recording: boolean;
  elapsed: number;
  onStart: () => void;
      ...
      <div className="card" style={{
        ...
        <div>
          ...
          <p style={{ margin: "6px 0 0", fontSize: 13.5, lineHeight: 1.55, color: "var(--text-secondary)" }}>
            ...
            Épelez les noms inhabituels. Vous pourrez tout relire et corriger juste après.
          </p>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, borderTop: "1px solid var(--border)", paddingTop: 16 }}>
          {recording ? (
            <>
              <span style={{ display: "flex", alignItems: "center", gap: 6, color: "var(--danger)", fontSize: 13, fontWeight: 600 }}>
                <MdFiberManualRecord style={{ animation: "alfred-pulse 1.4s ease-in-out infinite" }} />
