...
| 16b | Contexte par projet          | 📝 | **Post-v1, spec écrite, rien de codé.** Scinde le contexte appris entre global (`Contexte Alfred.md`) et par projet (`alfred-intelligence/<Projet>.md`, une note par projet) ; nouveau champ "Projets concernés" sur `/resolve` ; dépend du renommage de projet (ROADMAP Phase G) |
