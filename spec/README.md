...
| 24  | E-mails — connexion & extraction | 📝 | **Post-v1, spec écrite, rien de codé.** IMAP générique, fenêtre glissante (14j défaut), pas de note vault par mail (provenance texte non cliquable), extraction batchée (1 appel Claude/batch) → tâches + rattachement projet + contexte (réutilise le schéma spec/16b). Pivot de la vision « projets unifiés » (ROADMAP Phase G) |
