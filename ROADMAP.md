...
| [~] | **Voix du majordome — passe éditoriale (spec/10)** : le ton « majordome » n'existe que sur les labels d'état (« À votre service », « Je cogite… »…) ; relire l'ensemble des textes (boutons, placeholders, erreurs, onboarding) pour un ton cohérent de bout en bout, sans nuire à la lisibilité des messages d'erreur | CF |
